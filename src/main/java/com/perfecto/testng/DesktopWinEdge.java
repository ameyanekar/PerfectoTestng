...
public class DesktopWinEdge {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "DesktopWinEdge"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Desktop Win Edge", new TestContext("Win", "Edge")); //Starts the reportium test
