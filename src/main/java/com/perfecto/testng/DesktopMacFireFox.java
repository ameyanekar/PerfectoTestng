...
public class DesktopMacFireFox {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "DesktopMacFireFox"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Desktop Mac FireFox", new TestContext("Mac", "FireFox")); //Starts the reportium test
