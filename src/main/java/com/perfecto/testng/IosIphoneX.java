...
public class IosIphoneX {
    ...
    public void seleniumTest() throws Exception {
        ...
        capabilities.setCapability("model", "iPhone-X");
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "IosIphoneX"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Android iOS Iphone X", new TestContext("iOS", "IphoneX")); //Starts the reportium test
