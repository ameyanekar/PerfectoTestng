...
public class DesktopWinIE {
    ...
    public void seleniumTest() throws Exception {
        ...
        //Replace <token> with your perfecto security token or pass it as maven properties: -DsecurityToken=<<SECURITY TOKEN>>  More info: https://developers.perfectomobile.com/display/PD/Generate+security+tokens
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "DesktopWinIE"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Desktop Win IE", new TestContext("Win", "IE")); //Starts the reportium test
