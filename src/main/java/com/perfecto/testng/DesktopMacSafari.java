...
public class DesktopMacSafari {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "DesktopMacSafari"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Desktop Mac Safari", new TestContext("Mac", "Safari")); //Starts the reportium test
