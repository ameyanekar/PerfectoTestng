...
public class DesktopWinFirefox {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "DesktopWinFireFox"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Desktop Win Firefox", new TestContext("Win", "FireFox")); //Starts the reportium test
