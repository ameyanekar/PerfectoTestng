...
public class AndroidPixel4 {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "AndroidPixel4"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Android Pixel 4", new TestContext("Android", "Pixel4")); //Starts the reportium test
