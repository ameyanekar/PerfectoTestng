...
public class AndroidGalaxyNote10 {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "AndroidGalaxyNote10"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Android GalaxyNote 10", new TestContext("Android", "GalaxyNote10")); //Starts the reportium test
