...
public class DesktopMacChrome {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "DesktopMacChrome"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Desktop Mac Chrome", new TestContext("Mac", "Chrome")); //Starts the reportium test
