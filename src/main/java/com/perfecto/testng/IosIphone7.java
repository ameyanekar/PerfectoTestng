...
public class IosIphone7 {
    ...
    public void seleniumTest() throws Exception {
        ...
        try {
            reportiumClient = Utils.setReportiumClient(driver, reportiumClient, "IosIphone7"); //Creates reportiumClient
            reportiumClient.testStart("Perfecto Android iOS Iphone 7", new TestContext("iOS", "Iphone7")); //Starts the reportium test
